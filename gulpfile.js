...
gulp.task('scss', function () {
    return gulp.src([paths.src.scss + '/leo/**/*.scss', paths.src.scss + '/leo.scss'])
        .pipe(wait(500))
...
gulp.task('serve', gulp.series('scss', 'html', 'docs', 'index', 'assets', 'vendor', function() {
    ...
    gulp.watch([paths.src.scss + '/leo/**/*.scss', paths.src.scss + '/leo.scss'], gulp.series('scss'));
